...
export const PATCH = withFondsRoute({ module: "procedures", hostGuard: "afdwingen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.afschriften.wijzigen" }, capability: "procedures.manage", label: "procedures.afschrift.intrekken.PATCH", schema: z.object({ "reden": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
