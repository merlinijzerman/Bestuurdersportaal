...
export const GET = withFondsRoute({ capability: "procedures.view", hostGuard: true, label: "procedures.afschrift.download.GET", schema: "geen-body" }, async (ctx, req: NextRequest, params) => {
