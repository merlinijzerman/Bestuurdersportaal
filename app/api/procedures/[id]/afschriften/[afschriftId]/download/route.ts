...
export const GET = withFondsRoute({ module: "procedures", hostGuard: "afdwingen", rateLimit: "nog-niet-beoordeeld", audit: "geen", capability: "procedures.view", label: "procedures.afschrift.download.GET", schema: "geen-body" }, async (ctx, req: NextRequest, params) => {
