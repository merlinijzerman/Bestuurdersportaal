...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.fase-toelichting.aanmaken" }, capability: "procedures.manage", schema: z.object({ "fase_code": z.unknown().optional(), "toelichting": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
