...
export const POST = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.checklist.aanmaken" }, capability: "procedures.manage", schema: z.object({ "bewijs_vereist": z.unknown().optional(), "label": z.unknown().optional(), "stap_id": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
