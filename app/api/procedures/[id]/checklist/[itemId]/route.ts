...
export const PATCH = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.checklist.wijzigen" }, capability: "procedures.manage", schema: z.object({ "actief": z.unknown().optional(), "opmerking": z.unknown().optional(), "reden": z.unknown().optional(), "voldaan": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
