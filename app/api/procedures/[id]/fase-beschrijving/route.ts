...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.fase-beschrijving.aanmaken" }, capability: "procedures.manage", schema: z.object({ "beschrijving": z.unknown().optional(), "fase_code": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
