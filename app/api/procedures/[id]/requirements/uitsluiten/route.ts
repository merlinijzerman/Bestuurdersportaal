...
export const POST = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.requirements.uitsluiten" }, capability: "procedures.manage", schema: z.object({ "documenttype": z.unknown().optional(), "label": z.unknown().optional(), "reden": z.unknown().optional(), "requirement_type": z.unknown().optional(), "stap_volgorde": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
