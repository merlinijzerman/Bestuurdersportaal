...
// governance_event.
export const PATCH = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.requirements.wijzigen" }, capability: "procedures.manage", schema: z.object({ "actief": z.unknown().optional(), "motivering": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
