...
export const POST = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.bewijs.aanmaken" }, capability: "procedures.manage", schema: z.object({ "beschrijving": z.unknown().optional(), "document_id": z.unknown().optional(), "documenttype": z.unknown().optional(), "stap_id": z.unknown().optional(), "titel": z.unknown().optional(), "vereiste": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
