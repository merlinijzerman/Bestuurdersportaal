...
export const POST = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.stappen.agendapunt-koppelen" }, capability: "procedures.manage", schema: z.object({ "beschrijving": z.unknown().optional(), "categorie": z.unknown().optional(), "titel": z.unknown().optional(), "vergadering_id": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
