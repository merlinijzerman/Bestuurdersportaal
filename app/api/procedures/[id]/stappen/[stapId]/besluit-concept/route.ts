...
export const POST = withFondsRoute({ module: "procedures", hostGuard: "geen", rateLimit: "route-eigen", audit: "geen", capability: "procedures.manage", schema: "geen-body" }, async (ctx, req: NextRequest, params) => {
  try {
