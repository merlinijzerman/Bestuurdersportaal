...
export const POST = withFondsRoute({ module: "procedures", hostGuard: "afdwingen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "procedures.afschrift.aanmaken" }, capability: "procedures.manage", label: "procedures.afschrift.POST", schema: z.object({ "aanleiding": z.unknown().optional(), "aiLeeswijzer": z.unknown().optional(), "leeswijzerTekst": z.unknown().optional(), "versie": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
