...
export const GET = withFondsRoute({ hostGuard: "afdwingen", rateLimit: "nog-niet-beoordeeld", audit: "geen", capability: "assurance.view", label: "aqlab.assurance.audit.GET", schema: "geen-body" }, async (ctx, req, params) => {
