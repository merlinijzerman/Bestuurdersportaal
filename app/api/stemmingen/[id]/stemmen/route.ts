...
// ============================================================
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "stemmingen.stem-uitbrengen" }, capability: "stemming.deelname", schema: z.object({ "keuze": z.unknown().optional(), "motivering": z.unknown().optional(), "stemgerechtigde_id": z.unknown().optional(), "volmacht_bevestigd": z.unknown().optional(), "volmacht_toelichting": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
