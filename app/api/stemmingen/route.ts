...
// ============================================================
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "stemmingen.aanmaken" }, capability: "stemming.deelname", schema: z.object({ "agendapunt_id": z.unknown().optional(), "alternatieven": z.unknown().optional(), "vereist_quorum": z.unknown().optional(), "vereiste_meerderheid": z.unknown().optional(), "vraag": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest) => {
  try {
