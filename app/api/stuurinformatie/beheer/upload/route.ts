...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "route-eigen", audit: "geen", capability: "stuurinformatie.manage", schema: "geen-body" }, async (ctx, req: NextRequest) => {
  try {
