...
import { schrijfPeriode, slaBalansReservesOp } from "@/core/lib/stuurinfo-beheer";
import {
...
// ============================================================
//  /api/stuurinformatie/beheer — beheer-invoerlaag stuurinformatie (T14).
//
...
//         balansevenwicht 422). Opslaan publiceert direct naar het dashboard
//         (geen vier-ogen — bewust besluit, decisions/0075); elke mutatie
//         wordt door de DB-trigger append-only gelogd.
//
