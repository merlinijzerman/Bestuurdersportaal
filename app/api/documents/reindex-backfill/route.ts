...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "route-eigen", audit: { handeling: "documents.reindex-backfill.post" }, capability: "beheer.backfill", schema: "geen-body" }, async (ctx, req: NextRequest) => {
  try {
