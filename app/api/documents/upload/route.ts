...
export const POST = withFondsRoute({ hostGuard: "route-eigen", rateLimit: "route-eigen", audit: { handeling: "documents.upload.post" }, capability: "documents.metadata.update", schema: z.object({ "agendapunt_id": z.unknown().optional(), "bestandsnaam": z.unknown().optional(), "bibliotheek": z.unknown().optional(), "bron": z.unknown().optional(), "bronstatus": z.unknown().optional(), "bronstatus_reden": z.unknown().optional(), "document_id": z.unknown().optional(), "documentdatum": z.unknown().optional(), "documenttype": z.unknown().optional(), "grootte": z.unknown().optional(), "mimeType": z.unknown().optional(), "mode": z.unknown().optional(), "opslag_pad": z.unknown().optional(), "quarantaine_pad": z.unknown().optional(), "retire_reden": z.unknown().optional(), "status": z.unknown().optional(), "status_reden": z.unknown().optional(), "titel": z.unknown().optional(), "vervangt_rapportage_id": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest) => {
