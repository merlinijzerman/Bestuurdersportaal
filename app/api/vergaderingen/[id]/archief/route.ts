...
export const POST = withFondsRoute({ module: "vergaderingen", hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "vergaderingen.archiveren" }, capability: "vergaderingen.manage", schema: z.object({ "actie": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
