...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "decisions.conditions.aanmaken" }, capability: "decisions.manage", schema: z.object({ "deadline": z.unknown().optional(), "drempelwaarde": z.unknown().optional(), "eigenaar_naam": z.unknown().optional(), "heroverwegingstrigger": z.unknown().optional(), "kpi": z.unknown().optional(), "monitorfrequentie": z.unknown().optional(), "status": z.unknown().optional(), "voorwaarde": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
    ...
    return NextResponse.json({ condition: zonderLegeRequirementSleutel(nieuw) }, { status: 201 });
  } catch (e) {
