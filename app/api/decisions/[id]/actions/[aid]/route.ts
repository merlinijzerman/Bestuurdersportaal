...
export const PATCH = withFondsRoute({ capability: "decisions.manage", schema: z.object({ "status": z.unknown().optional(), "voorwaarde_id": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
