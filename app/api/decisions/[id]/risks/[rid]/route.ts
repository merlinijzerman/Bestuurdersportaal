...
export const PATCH = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "decisions.id.risks.rid.patch" }, capability: "decisions.manage", schema: z.object({ "categorie": z.unknown().optional(), "impact": z.unknown().optional(), "kans": z.unknown().optional(), "status": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
