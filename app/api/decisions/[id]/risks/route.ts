...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "decisions.risks.aanmaken" }, capability: "decisions.manage", schema: z.object({ "beschrijving": z.unknown().optional(), "categorie": z.unknown().optional(), "eigenaar_naam": z.unknown().optional(), "impact": z.unknown().optional(), "kans": z.unknown().optional(), "mitigatie": z.unknown().optional(), "residual_risk": z.unknown().optional(), "risicomatrix_id": z.unknown().optional(), "status": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
