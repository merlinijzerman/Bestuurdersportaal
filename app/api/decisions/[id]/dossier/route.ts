...
export const GET = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: "geen", capability: "decisions.view", schema: "geen-body" }, async (ctx, _req: NextRequest, params) => {
  try {
