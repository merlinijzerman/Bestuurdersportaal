...
export const PATCH = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "decisions.wijzigen" }, capability: "decisions.manage", schema: z.object({ "classificatie_bevestigd": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
