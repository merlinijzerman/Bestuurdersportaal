...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "decisions.assumptions.aanmaken" }, capability: "decisions.manage", schema: z.object({ "ai_gedetecteerd": z.unknown().optional(), "bron_document_id": z.unknown().optional(), "evaluatiecriterium": z.unknown().optional(), "onzekerheid": z.unknown().optional(), "status": z.unknown().optional(), "tekst": z.unknown().optional(), "type": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
