...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "route-eigen", audit: { handeling: "classificatie.bulk-herclassificeren" }, capability: "beheer.backfill", schema: "geen-body" }, async (ctx, _req: NextRequest) => {
  try {
