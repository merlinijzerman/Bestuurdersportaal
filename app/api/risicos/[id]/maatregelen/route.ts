...
export const POST = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "risicos.maatregelen.aanmaken" }, capability: "risicos.manage", schema: z.object({ "beschrijving": z.unknown().optional(), "verantwoordelijke": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
