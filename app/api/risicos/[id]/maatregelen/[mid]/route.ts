...
export const PATCH = withFondsRoute({ hostGuard: "geen", rateLimit: "nog-niet-beoordeeld", audit: { handeling: "risicos.id.maatregelen.mid.patch" }, capability: "risicos.manage", schema: z.object({ "beschrijving": z.unknown().optional(), "status": z.unknown().optional(), "verantwoordelijke": z.unknown().optional() }).passthrough() }, async (ctx, req: NextRequest, params) => {
  try {
