...
import { dekkingslabel } from "@/core/lib/document-dekking";

// P1a — `OnderbouwingMeta` woont sinds de laagsplitsing in
// `core/lib/assistent-types.ts`; de gesprekslaag (L2) vult hem uit het
// meta/done-event en mag daarvoor niet uit `app/` importeren. Hier
// ongewijzigd doorgegeven: elke bestaande importregel blijft werken.
export type { OnderbouwingMeta } from "@/core/lib/assistent-types";
import type { OnderbouwingMeta } from "@/core/lib/assistent-types";
