-- #428 Production self-check (read-only).
do $$
...
begin
  ...
  then raise exception '#428 Production-hostisolatie faalt'; end if;
  ...
  then raise exception '#428 Production-modulematrix faalt'; end if;
  if exists (
  ...
  then raise exception '#428 Production-flagmatrix faalt'; end if;
  ...
  then raise exception '#428 Production-inerte beginstand faalt'; end if;
end $$;
