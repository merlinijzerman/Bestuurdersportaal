-- ROLLBACK van 2026_08_28_p3d_04_open_per_decision.sql (P3/PR-D, #168, 0193).
-- Herstelt de 1-arg fn_stap_open_per_zwaarte (primary-afgeleid) van PR-C.
begin;

drop function if exists public.fn_stap_open_per_zwaarte(uuid, uuid);
