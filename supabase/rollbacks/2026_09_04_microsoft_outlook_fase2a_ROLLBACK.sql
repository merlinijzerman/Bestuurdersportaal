...
revoke execute on function microsoft_private.outlook_markeer_extern_gewijzigd(uuid,text) from microsoft_vault;
...
drop function if exists microsoft_private.outlook_markeer_extern_gewijzigd(uuid,text);
