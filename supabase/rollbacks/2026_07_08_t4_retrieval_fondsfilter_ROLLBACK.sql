-- ============================================================================
-- ROLLBACK van 2026_07_08_t4_retrieval_fondsfilter.sql
-- ----------------------------------------------------------------------------
-- Herstelt de retrieval-RPC's naar de 20g-staat (Increment G): zonder de T4-
-- param `p_fonds_id`, zonder de published-only-generiek-gate en zonder de
-- return-kolom `fonds_id`. Drop de T4-signaturen, recreate de 20g-bodies.
--
-- Let op: na deze rollback verwacht de app-code (lib/rag.ts) géén `fonds_id` in
-- de RPC-return meer en geeft geen `p_fonds_id` mee — draai daarom de code-deploy
-- terug samen met deze rollback (RLS blijft de tenant-isolatie afdwingen).
-- Idempotent.
-- ============================================================================

-- ── 1. Drop de T4-signaturen ────────────────────────────────────────────────
...
-- ── 3. Recreate zoek_chunks_hybride (20g) ───────────────────────────────────
