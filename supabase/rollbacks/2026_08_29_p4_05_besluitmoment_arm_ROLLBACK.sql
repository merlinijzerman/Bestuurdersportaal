-- ROLLBACK van 2026_08_29_p4_05_besluitmoment_arm.sql (P4 tranche 5).
-- Herstelt fn_stap_open_per_zwaarte naar de p3d_04-versie (zonder besluitmoment-arm).
-- LET OP: draai alleen terug als besluitmoment_stap nergens gevuld is (0193) —
-- anders telt de SQL-open-berekening minder open dan §7 voorschrijft.
