-- ROLLBACK van 2026_08_14_readiness_blokkerend_ambiguiteit_fix.sql
-- Herstelt de d7c-definitie zonder de #variable_conflict-directive
-- (let op: herintroduceert de ambiguïteit-bug).
