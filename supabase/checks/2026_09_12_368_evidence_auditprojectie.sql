...
do $$
declare
  v_ok jsonb := '{"evidence_audit":[{"correlation_id":"corr-368","soort":"semantische_unit","gevraagd":1,"toegelaten":1,"gerenderde_tekens":100,"limiet":500,"afgekapt":false}],"modelcontext_audit":[{"correlation_id":"corr-368","soort":"risicos","pii":"geen","gerenderde_tekens":80,"limiet":500,"afgekapt":false}]}'::jsonb;
...
begin
  ...
  if public.meta_basisniveau('{"modelcontext_audit":[{"correlation_id":"c","soort":"risicos","pii":"geen","gerenderde_tekens":1,"limiet":1,"afgekapt":false,"detail":"lek"}]}'::jsonb) ? 'modelcontext_audit' then
