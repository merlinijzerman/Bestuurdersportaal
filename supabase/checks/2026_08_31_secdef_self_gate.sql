...
begin
  ...
  insert into secdef_beleid (identiteit, klasse, motivering) values
    ...
    ('fn_stap_activeerbaar_maken(p_stap_id uuid, p_procedure_id uuid)', 'rol_fonds', 'Stapmutatie binnen een procedure in het eigen fonds.'),
    ('fn_stap_activeren(p_stap_id uuid, p_procedure_id uuid)', 'rol_fonds', 'Stapmutatie binnen een procedure in het eigen fonds.'),
    ('fn_stap_afronden(p_stap_id uuid, p_procedure_id uuid)', 'rol_fonds', 'Stapmutatie binnen een procedure in het eigen fonds.'),
