-- Rollback van 2026_08_15_t14b_production_drift_repair.sql.
-- Zet uitsluitend capture, policy en RPC terug naar de T14-basisversie.
-- De veilige grant-hygiëne blijft behouden.
