...
| [0046](./0046-cross-tenant-testsuite-testdb-strategie.md) | T5: cross-tenant testsuite (§15 T1–T14) blokkerend in CI op een **ephemere Supabase-CLI test-DB** (optie A); optie B (`TEST_DATABASE_URL`-branch-DB) blijft als niet-blokkerende nachtelijke fideliteitsrun; versie-pinning (PG14 + pgvector 0.8.0) en storage-config-als-migratie beide gevalideerd | Geaccepteerd | 2026-07-09 |
